...
export default function InstitutionsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      <h1 className="text-3xl font-bold mb-6">Islamic Institutions</h1>
                          ...
                          {inst.admissionStatus ? (
                            <>
                              <p className="text-gray-700 dark:text-gray-300">
                                এখন ভর্তি চলছে! ভর্তি প্রক্রিয়ার জন্য নিচে
                                ক্লিক করুন!
                              </p>
                              <button
                                onClick={() =>
                            ...
                            <>
                              <p className="text-gray-700 dark:text-gray-300">
                                নোটঃ এখন ভর্তি কার্যক্রম বন্ধ। আপনার ইমেইল
                                ঠিকানা নিচে দিয়ে রাখুন। ভর্তি কার্যক্রম চালু
                      ...
                      <div className="space-y-4 text-gray-700 dark:text-gray-300">
                        ...
                        <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                          ...
                          <ul className="list-disc list-inside space-y-2">
                            ...
                            <li>
                              প্রধান কার্যালয়ঃ ৩৭০ বি, বাইতুচ ছালাম ভবন,
                              আল-আমীন রোড, শুলকবহর, বহদ্দারহাট, চট্টগ্রাম
                            </li>
                          </ul>
                        </div>
                      </div>
